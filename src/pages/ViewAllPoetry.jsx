  ...
  return (
    <div className="container px-10 pt-8 bg-green-300 h-screen ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 place-content-center  lg:grid-cols-4 xl:grid-cols-5 gap-6 ">
        {poetryData.map((poem) => (
          <div key={poem.id} className="bg-white p-6 rounded-md shadow-md hover:shadow-lg transition duration-300">
            <h3 className="text-xl font-semibold mb-4 text-blue-500">{poem.name}</h3>
